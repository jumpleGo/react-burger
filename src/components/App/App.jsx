...
import {addModalIngredient, cleanModalData, getIngredients} from "../../services/actions/store";
...
import {ProtectedRouteElement} from "../../services/utils/protectedRoute";
...
function App() {
    ...
    const itemById = useSelector(state => getIngredientById(state, routeState?.id))
    useEffect(() => {
        if (itemById) {
