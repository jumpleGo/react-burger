    ...
    return (
        <main className={LoginStyles.wrapper}>
            ...
            <form onSubmit={action} className={LoginStyles.form}>
                ...
                <Button extraClass={'mt-6'} size="large" htmlType={'submit'} disabled={!email || !password}>
                    Войти
                </Button>
            </form>
            <div className={`${LoginStyles.footer} mt-20`}>
                <div className={`${LoginStyles.linkBlock} text_type_main-default`}>
                    ...
                    <NavLink className={LoginStyles.link} to="/register">Зарегистрироваться</NavLink>
                </div>
                <div className={`${LoginStyles.linkBlock} mt-4 text_type_main-default`}>
                    <span>Забыли пароль?</span>
                    <NavLink className={LoginStyles.link} to="/forgot-password">Восстановить пароль</NavLink>
                </div>
            </div>
        </main>
    )
